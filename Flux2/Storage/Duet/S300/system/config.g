...
M552 P192.168.1.10				; Enable Networking
...
M208 X-35:328.5 Y-49:200 Z0:290 C-45:360	 				; Set axis maxima & minima
...
M201 X6000 Y6000 Z400 C5000 E2500:2500:2500:2500		; Set accelerations (mm/s^2)
M906 X1800 Y1800 Z1330 I30   							; Idle motion motors to 30%
M906 E2000:1000:1000:1000 C500 I10     					; Idle extruder motors to 10%

; Endstops
M574 X2 S1 P"x_stop"   ; X min active high endstop switch
M574 Y1 S1 P"y_stop"   ; Y min active high endstop switch
...
M557 X6:294 Y4:196 S48 			; Define mesh grid
...
M143 H1 S325 													; Set temperature limit for heater 1 to 300C
...
M572 D0 S0.026						; pressure advance T0
M572 D1 S0.026						; pressure advance T1
