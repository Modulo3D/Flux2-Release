...
namespace Flux.ViewModels
{
        ...
        where TConditionAttribute : FeederOperationConditionAttribute
    {
        ...
        [RemoteCommand]
        public ReactiveCommandBaseRC<Unit, Unit> CancelOperationCommand { get; private set; }
        [RemoteCommand]
        public ReactiveCommandBaseRC<Unit, Unit> ExecuteOperationCommand { get; private set; }
